...
sr.reveal(
  ".hero__title , .features__container , .companies__pretitle , .companies__title, .testimonials__pretitle, testimonials__title, .newsletter__container, .footer__container"
);
